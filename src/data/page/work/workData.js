...
const workProjects = [
  {
    ...
    url: "https://cio.gov",
    summary:
      "Modernised the Federal CIO Council experience with an accessible design system and faster publication workflow.",
  ...
  },
  {
    ...
    url: "https://sam.gov",
    summary:
      "Rebuilt vendor onboarding flows to simplify registrations for millions of suppliers supporting federal procurement.",
  ...
  },
  {
    ...
    summary:
      "Partnered with innovation teams to launch analytics dashboards for mission-critical aerospace programmes.",
  ...
  },
  {
    ...
    summary:
      "Crafted a modular marketing platform powering regional launches across mobility, climate, and manufacturing divisions.",
  ...
  },
  {
    id: "axen-route",
    client: "Axen Route",
    url: "https://www.axenroute.com/",
    summary:
      "Delivered a brand-forward web presence that showcases Axen Route&apos;s integrated logistics and intelligence services.",
    ...
    outcomes: [
      "Increased qualified lead submissions by 44% within two months",
      "Lifted lighthouse performance scores into the 90th percentile across form flows",
    ],
  },
  {
    id: "airflow-solution",
    ...
    summary:
      "Built a B2B commerce portal streamlining HVAC partner onboarding and automated quote generation.",
  ...
  },
  {
    ...
    summary:
      "Launched a responsive marketing site and scheduling workflow for nationwide installation crews.",
  ...
  },
  {
    ...
    summary:
      "Created a developer-facing profile generator that transforms Git repositories into client-ready resumes.",
